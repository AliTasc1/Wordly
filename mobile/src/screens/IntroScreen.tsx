...
export function IntroScreen() {
  ...
  return (
    <Screen
      ...
      gap={24}
      glows={[
        { rx: 210, ry: 160, cx: 0.8, cy: 0.08, color: colors.accent, opacity: 0.14, stop: 0.62 },
      ]}>
      ...
      <View style={styles.copy}>
        ...
        <Txt s={14.5} lh={1.55} c={colors.textDim}>
          {INTRO.body}
        </Txt>
      </View>
...
const styles = StyleSheet.create({
  ...
  dot: { width: 10, height: 5, borderRadius: 9, backgroundColor: alpha.w16 },
